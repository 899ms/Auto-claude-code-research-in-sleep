...
- [![ARIS-in-AI-Offer](https://img.shields.io/github/stars/wanshuiyin/ARIS-in-AI-Offer?style=flat&logo=github&logoColor=white&label=ARIS--in--AI--Offer&color=1E88E5)](https://github.com/wanshuiyin/ARIS-in-AI-Offer) — 34 bilingual ML / LLM interview cheat sheets on [one page](https://wanshuiyin.github.io/ARIS-in-AI-Offer/): formula derivations, from-scratch PyTorch, 25 questions each (L1 / L2 / L3), all made with `/render-html`. 希望大家秋招轻松一点 🌱
- [![HERO](https://img.shields.io/github/stars/wanshuiyin/HERO-Anti-OverDefense?style=flat&logo=github&logoColor=white&label=HERO&color=2E7D32)](https://github.com/wanshuiyin/HERO-Anti-OverDefense) — a ~550-token block for `CLAUDE.md` / `AGENTS.md` against the four shapes agents over-defend in (Hashing, Edge cases, Rubrics, Overbuild); bounds what the agent *proposes*, never what it *looks for*.
- [![Anti-Autoresearch](https://img.shields.io/github/stars/wanshuiyin/Anti-Autoresearch?style=flat&logo=github&logoColor=white&label=Anti--Autoresearch&color=B71C1C)](https://github.com/wanshuiyin/Anti-Autoresearch) — 61 integrity signals into a deterministic, reviewer-ready report; fabrication forensics, not an AI-text detector.
- [![ARIS-Movie-Director](https://img.shields.io/github/stars/wanshuiyin/ARIS-Movie-Director?style=flat&logo=github&logoColor=white&label=ARIS--Movie--Director&color=6A1B9A)](https://github.com/wanshuiyin/ARIS-Movie-Director) — a rough story in, a movie told in still frames out, every scene checked by another model; the same loop draws clean method diagrams (`/method-figure`).
